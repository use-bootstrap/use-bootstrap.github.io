...
function UseBootstrapDialogIcon() {
  return (
...
export default function () {
  const items = [
    {
      icon: <UseBootstrapDialogIcon />,
      name: 'use-bootstrap-dialog',
      desc: 'A JavaScript library for generating dialogs using Bootstrap modals',
      link: 'https://use-bootstrap-dialog.js.org',
    },
    {
